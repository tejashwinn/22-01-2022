...
"")
        ...
        self.comment_view_frame = QtWidgets.QFrame(self.post_posts_scroll_area_widget)
...
"\n"
"border:0px;")
        self.user_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.user_2.setObjectName("user_2")
        self.verticalLayout_3.addWidget(self.comment_view_frame)
...
"")
    ...
    def retranslateUi(self, posts_form):
        ...
        self.comment_2.setText(_translate("posts_form", "Comment"))
        self.user_2.setText(_translate("posts_form", "User"))
