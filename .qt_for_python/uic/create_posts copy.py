...
"border-radius: 8px;}")
        ...
        self.static_post_heading_posts = QtWidgets.QLabel(self.create_posts_frame)
        self.static_post_heading_posts.setGeometry(QtCore.QRect(20, 20, 181, 31))
        font = QtGui.QFont()
...
"color: #000000;\n"
"")
        self.static_post_heading_posts.setObjectName("static_post_heading_posts")
        self.static_description_label_create_post_label = QtWidgets.QLabel(self.create_posts_frame)
        self.static_description_label_create_post_label.setGeometry(QtCore.QRect(30, 170, 111, 41))
...
"text-transform: capitalize;\n"
"")
        self.static_description_label_create_post_label.setObjectName("static_description_label_create_post_label")
...
"color: #000000;")
        ...
        self.plainTextEdit_2.setGeometry(QtCore.QRect(20, 120, 511, 41))
...
"color: #000000;")
        ...
        self.static_create_post_heading_label = QtWidgets.QLabel(self.create_posts_frame)
        self.static_create_post_heading_label.setGeometry(QtCore.QRect(30, 80, 81, 41))
...
"text-transform: capitalize;\n"
"")
        self.static_create_post_heading_label.setObjectName("static_create_post_heading_label")
...
"")
        ...
        self.add_files_button_posts.setGeometry(QtCore.QRect(160, 420, 221, 40))
...
"")
        ...
        self.create_post_button = QtWidgets.QPushButton(self.create_posts_frame)
...
"")
        ...
        self.dynamic_create_post_warning_label = QtWidgets.QLabel(self.create_posts_frame)
        self.dynamic_create_post_warning_label.setGeometry(QtCore.QRect(30, 50, 481, 31))
...
"text-transform: capitalize;\n"
"color:red;")
        self.dynamic_create_post_warning_label.setObjectName("dynamic_create_post_warning_label")
    ...
    def retranslateUi(self, create_posts_form):
        ...
        self.static_post_heading_posts.setText(_translate("create_posts_form", "Create Post"))
        self.static_description_label_create_post_label.setText(_translate("create_posts_form", "Description"))
        self.static_create_post_heading_label.setText(_translate("create_posts_form", "Heading"))
        self.dynamic_file_name.setText(_translate("create_posts_form", "File Name: "))
        self.add_files_button_posts.setText(_translate("create_posts_form", "Add Files"))
        self.create_post_button.setText(_translate("create_posts_form", "Create Post"))
        self.dynamic_create_post_warning_label.setText(_translate("create_posts_form", "Heading"))
