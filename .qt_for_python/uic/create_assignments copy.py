...
# Form implementation generated from reading ui file 'c:\Users\tejas\Desktop\22-01-22\create_assignments copy.ui'
#
...
"border-radius: 8px;}")
        self.create_assignment_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        ...
        self.post_heading_posts = QtWidgets.QLabel(self.create_assignment_frame)
...
"color: #000000;")
        ...
        self.head_entry = QtWidgets.QPlainTextEdit(self.create_assignment_frame)
...
"")
        ...
        self.add_files_button = QtWidgets.QPushButton(self.create_assignment_frame)
...
"")
        ...
        self.date_time_edit = QtWidgets.QDateTimeEdit(self.create_assignment_frame)
...
"")
        ...
        self.marks_entry = QtWidgets.QPlainTextEdit(self.create_assignment_frame)
...
"")
        ...
        self.add_files_button_assignment = QtWidgets.QPushButton(self.create_assignment_frame)
        self.add_files_button_assignment.setGeometry(QtCore.QRect(160, 550, 221, 40))
...
"\n"
"")
        self.add_files_button_assignment.setObjectName("add_files_button_assignment")
...
"color: #FF0000;")
    ...
    def retranslateUi(self, Assignment_form):
        ...
        self.post_heading_posts.setText(_translate("Assignment_form", "Create Assignment"))
        self.static_des.setText(_translate("Assignment_form", "Description"))
        self.head_label.setText(_translate("Assignment_form", "Heading"))
        self.label_file_name.setText(_translate("Assignment_form", "File Name: "))
        self.add_files_button.setText(_translate("Assignment_form", "Add Files"))
        self.date_entry.setText(_translate("Assignment_form", "Date"))
        self.marks_label.setText(_translate("Assignment_form", "Marks:"))
        self.add_files_button_assignment.setText(_translate("Assignment_form", "Post Assignment"))
        self.warning_label.setText(_translate("Assignment_form", "warning"))
