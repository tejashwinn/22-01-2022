...
"color: #000000;")
        ...
        self.dynamic_des_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
...
"")
        ...
        self.submit_button_assignment = QtWidgets.QPushButton(self.assign_frame)
        self.submit_button_assignment.setGeometry(QtCore.QRect(170, 390, 191, 41))
...
"")
    ...
    def retranslateUi(self, Assignments):
        ...
        self.dynamic_heading_as.setText(_translate("Assignments", "Assignment Heading"))
        self.dynamic_des_label.setText(_translate("Assignments", "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat mass quis enim. Donec."))
        self.dynamic_files.setText(_translate("Assignments", "Files: "))
        self.submit_button_assignment.setText(_translate("Assignments", "Submit"))
        self.dynamic_as_date.setText(_translate("Assignments", "Assignment Date:"))
        self.dynamic_sub_date.setText(_translate("Assignments", "Submisson Date:"))
        self.download_button.setText(_translate("Assignments", "Download File"))
